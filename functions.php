 <?php
/**
 * SassyUnderscore functions and definitions
 *
 * @link https://developer.wordpress.org/themes/basics/theme-functions/
 *
 * @package SassyUnderscore
 */
...
if ( ! function_exists( 'underscoresass_setup' ) ) :
	...
	function underscoresass_setup() {
		 ...
		 * If you're building a theme based on SassyUnderscore, use a find and replace
...
add_action( 'after_setup_theme', 'underscoresass_setup' );
  ...
  */
 function underscoresass_resource_hints( $urls, $relation_type ) {
	 if ( wp_style_is( 'underscoresass-fonts', 'queue' ) && 'preconnect' === $relation_type ) {
		 $urls[] = array(
 ...
 add_filter( 'wp_resource_hints', 'underscoresass_resource_hints', 10, 2 );
